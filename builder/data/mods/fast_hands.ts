...
import { ReloadSpeedStrategy } from '../../src/mod_strategies'

class FastHands extends BaseMod implements Mod {
  ...
  constructor(rank?: number) {
    ...
    this._strategies = [ ReloadSpeedStrategy ]
    this.set_modifier('ReloadSpeed', new Modifier(0.05))
  }
